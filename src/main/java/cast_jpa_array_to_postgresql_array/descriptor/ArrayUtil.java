...
//            }
    ...
    public static Object[] wrapArray(Object originalArray) {
        ...
        if (boolean[].class.equals(arrayClass)) {
            ...
            return array;
        } else if (originalArray.getClass() == ArrayList.class) {
            return ((ArrayList) originalArray).toArray();
        }else {
    ...
    public static <T> T unwrapArray(Object[] originalArray, Class<T> arrayClass) {
        ...
        if (boolean[].class.equals(arrayClass)) {
          ...
          return array;
        } else if(ArrayList.class.equals(arrayClass)) {
            int arrayLength = originalArray.length;
            ArrayList array = new ArrayList();
            if (arrayLength > 0) {
                for (int i = 0; i < originalArray.length; i++) {
                    array.add(originalArray[i]);
                }
            }
            return (T) array;
        } else {
